...
) : Module<CommandResult>
{
	...
	)
	{
		...
		var packages = Directory.GetFiles(buildSettings.Value.ArtifactsFolder, "*.nupkg").Concat(Directory.GetFiles(buildSettings.Value.ArtifactsFolder, "*.snupkg")).ToArray();
