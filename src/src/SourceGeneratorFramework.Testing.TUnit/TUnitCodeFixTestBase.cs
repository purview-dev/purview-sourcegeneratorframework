...
/// <summary>TUnit-specific base class for analyzer and code fix tests.</summary>
	...
	where TOptions : CodeFixTestOptions, new()
{
	...
	/// <summary>Runs the analyzer and applies the selected code fix.</summary>
	...
	/// <summary>Runs the analyzer and applies the selected code fix using the supplied options.</summary>
