...
/// <summary>Executes a diagnostic analyzer against a test compilation.</summary>
public sealed class DiagnosticAnalyzerTestRunner<TAnalyzer> : RoslynTestRunner
	where TAnalyzer : DiagnosticAnalyzer, new()
{
	/// <summary>Runs the analyzer against one source file.</summary>
	...
	/// <summary>Runs the analyzer against the supplied source files.</summary>
