...
/// <summary>Framework-agnostic base class for diagnostic analyzer tests.</summary>
	...
	where TOptions : AnalyzerTestOptions, new()
{
	...
	/// <summary>Runs the analyzer against the supplied source.</summary>
	...
	/// <summary>Runs the analyzer against the supplied sources.</summary>
	protected Task<AnalyzerTestResult> AnalyzeAsync(
		IEnumerable<string> sources,
		CancellationToken cancellationToken = default
	) => AnalyzeAsync(sources, null!, cancellationToken);

	/// <summary>Runs the analyzer against the supplied source and options.</summary>
	protected Task<AnalyzerTestResult> AnalyzeAsync(
		string source,
		TOptions options,
		CancellationToken cancellationToken = default
	...
	/// <summary>Runs the analyzer against the supplied sources and options.</summary>
	...
	/// <summary>Called before the analyzer is run.</summary>
	...
	/// <summary>Called asynchronously before the analyzer is run.</summary>
	...
	/// <summary>Called after the analyzer is run.</summary>
	...
	/// <summary>Called asynchronously after the analyzer is run.</summary>
